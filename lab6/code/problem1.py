...
from sys import argv# It would be nice if we didn't have to do this:
...
def Test():
    ...
    net.addLink(host1, switch1, bw=30, delay='5ms', loss=0, use_htb=True)
    net.addLink(host2, switch2, bw=30, delay='5ms', loss=0, use_htb=True)
